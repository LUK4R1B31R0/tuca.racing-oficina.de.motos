    ...
    <div className="relative h-screen min-h-[600px] flex items-center overflow-hidden bg-neutral-950">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
        <div className="max-w-2xl text-left">
          ...
          <div className="mt-12 flex flex-col sm:flex-row sm:items-center gap-8 border-t border-white/10 pt-8 text-left">
            <div>
            ...
            <div>
              <p className="text-white font-oswald text-2xl font-bold">100%</p>
              <p className="text-neutral-400 text-[10px] uppercase tracking-wider font-bold">Transparência Técnica</p>
            </div>
          </div>
        </div>
      </div>
